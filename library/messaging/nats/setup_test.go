...
import (
	"fmt"
	ulog "git.u-linke.com/ulink/commons/library/log"
	"git.u-linke.com/ulink/commons/library/messaging"
	"git.u-linke.com/ulink/commons/library/messaging/nats"
...
func TestMain(m *testing.M) {
	...
	logger := ulog.NewLogger(".", "test", hclog.Level(1), true, ulog.NsqConfig{})
	if err != nil {
